    ...
    <div>
      ...
      <div className="burger-popover-container">
          <div onClick={()=>goToSettings()} className="burger-popover-item d-flex p-2 align-items-center">
            ...
            <span className="ml-2 white-space-nowrap">Settings</span>
          </div>
          <div onClick={()=>lockWallet()} className="burger-popover-item d-flex p-2 align-items-center">
            ...
            <span className="ml-2 white-space-nowrap">Lock wallet</span>
          </div>
          <div className="burger-popover-item d-flex p-2 align-items-center">
            ...
            <span className="ml-2 white-space-nowrap">Help&Support</span>
          </div>
          <div onClick={()=>addWallet()} className="burger-popover-item d-flex p-2 align-items-center">
            ...
            <span className="ml-2 white-space-nowrap">Add wallet</span>
          </div>

          <div onClick={()=>changeAddress()} className="burger-popover-item d-flex p-2 align-items-center">
            <svg xmlns="http://www.w3.org/2000/svg" width="19" height="18" viewBox="0 0 19 18" fill="none">
              <path className="isColorable" fill="white" d="M4.70599 6.53036H13.883L12.753 7.37734C12.679 7.43334 12.617 7.5033 12.569 7.5823C12.522 7.6623 12.491 7.75131 12.478 7.84231C12.465 7.93431 12.47 8.02833 12.493 8.11733C12.516 8.20733 12.556 8.29236 12.612 8.36636C12.678 8.45336 12.763 8.52531 12.861 8.57431C12.959 8.62331 13.067 8.64834 13.177 8.64834C13.329 8.64834 13.478 8.59935 13.6 8.50735L16.424 6.38931C16.51 6.32331 16.58 6.23832 16.628 6.14132C16.677 6.04432 16.702 5.93733 16.702 5.82833C16.702 5.71933 16.677 5.61235 16.628 5.51535C16.58 5.41835 16.51 5.33336 16.424 5.26736L13.699 3.14932C13.551 3.03432 13.364 2.98234 13.178 3.00534C12.992 3.02934 12.822 3.12534 12.707 3.27334C12.592 3.42034 12.54 3.60834 12.564 3.79434C12.587 3.98034 12.683 4.14931 12.831 4.26431L13.939 5.11935H4.70599C4.51899 5.11935 4.339 5.19334 4.207 5.32534C4.074 5.45834 4 5.63731 4 5.82431C4 6.01231 4.074 6.19131 4.207 6.32431C4.339 6.45631 4.51899 6.53036 4.70599 6.53036ZM16 11.4723H6.82401L7.953 10.6253C8.103 10.5123 8.202 10.3453 8.228 10.1603C8.255 9.9743 8.20699 9.78632 8.09399 9.63632C7.98199 9.48732 7.815 9.38835 7.629 9.36135C7.444 9.33535 7.25599 9.38333 7.10599 9.49533L4.28201 11.6133C4.19601 11.6793 4.126 11.7644 4.078 11.8614C4.03 11.9584 4.005 12.0653 4.005 12.1743C4.005 12.2833 4.03 12.3903 4.078 12.4873C4.126 12.5843 4.19601 12.6693 4.28201 12.7353L7.00699 14.8534C7.12999 14.9494 7.28199 15.0013 7.43799 15.0013C7.54599 15.0013 7.65199 14.9763 7.74899 14.9283C7.84499 14.8813 7.93 14.8113 7.995 14.7263C8.11 14.5793 8.16201 14.3923 8.13901 14.2073C8.11701 14.0223 8.022 13.8533 7.875 13.7383L6.767 12.8833H16C16.188 12.8833 16.367 12.8093 16.499 12.6773C16.632 12.5443 16.706 12.3653 16.706 12.1783C16.706 11.9903 16.632 11.8113 16.499 11.6783C16.367 11.5463 16.188 11.4723 16 11.4723Z"/>
            </svg>
            <span className="ml-2 white-space-nowrap">Change address</span>
          </div>
